...
public class FlightBookingAutomation {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/header/div[1]/div/div[2]/div[2]/button"))).click();
        ...
        wait.until(ExpectedConditions.elementToBeClickable(
        		By.xpath("/html/body/div[2]/div/div/div[3]/div/main/div[2]/div[2]/div[1]/div/div[1]/div[2]/div[1]/div[4]/button")))
        .click();
