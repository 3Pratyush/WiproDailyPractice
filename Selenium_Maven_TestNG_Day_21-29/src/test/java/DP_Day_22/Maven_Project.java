...
import java.time.Duration;
	...
	public class Maven_Project {
	    ...
	    public static void main(String[] args) {
	        ...
	        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("ap_email_login"))).sendKeys("8917599639");

	       
	        driver.findElement(By.id("continue")).click();

	        
	        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("ap_password"))).sendKeys("Password@12");
